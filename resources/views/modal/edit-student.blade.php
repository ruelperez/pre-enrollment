...
<div wire:ignore.self class="modal" tabindex="-1" role="dialog" id="edit{{$result->id}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form style="width: 96%; margin-left: 2%;">
                    ...
                    @enderror
                    <button type="button" class="btn btn-primary" style="width: 70%; margin-left: 15%; margin-top: 5%;" wire:click="submit_edit({{$result->id}})" >Submit</button>
                </form>
            </div>
        </div>
    </div>
