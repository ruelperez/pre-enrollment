...
<div wire:ignore.self class="modal" tabindex="-1" role="dialog" id="add_student">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form wire:submit.prevent="submit_reg_student" style="width: 96%; margin-left: 2%;">
                    ...
                    @enderror
                    <button type="submit" class="btn btn-primary" style="width: 70%; margin-left: 15%; margin-top: 5%;" >Submit</button>
                </form>
            </div>
        </div>
    </div>
